    ...
    stages {
        ...
        stage('Deploy to Tomcat') {
            steps {
                ...
                deploy adapters: [tomcat9(alternativeDeploymentContext: '', credentialsId: 'tomcat', path: '', url: 'http://ec2-13-218-35-142.compute-1.amazonaws.com:8081/')], contextPath: 'MC-APP', war: '**/*.war'
            }
        }		
