    ...
    stages {
        ...
        stage('Deploy to Tomcat') {
            steps {
                ...
                deploy adapters: [tomcat9(alternativeDeploymentContext: '', credentialsId: 'tomcat', path: '', url: 'http://ec2-98-84-171-112.compute-1.amazonaws.com:8081/')], contextPath: 'MC-APP', war: '**/*.war'
            }
        }		
